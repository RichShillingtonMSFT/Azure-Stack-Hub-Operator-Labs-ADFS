...
$PEPSession = New-PSSession -ComputerName 'PutPEPIPHere' -ConfigurationName PrivilegedEndpoint -Credential $PEPCredentials -SessionOption (New-PSSessionOption -Culture en-US -UICulture en-US)
...
Connect-AzAccount -Environment "AzS-Admin" -ServicePrincipal -Credential $SPCredential -Tenant 'PutTenantIdHere'

Connect-AzAccount -Environment "AzS-User" -ServicePrincipal -Credential $SPCredential -Tenant 'PutTenantIdHere'
