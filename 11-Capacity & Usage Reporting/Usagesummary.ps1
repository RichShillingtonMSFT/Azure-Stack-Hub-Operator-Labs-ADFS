...
foreach ($subID in $subtable) {
    ...
    $result = Get-AzsSubscriberUsage -SubscriberId $subID.SubscriptionId -ReportedStartTime $StartTime -ReportedEndTime $EndTime -AggregationGranularity $Granularity
